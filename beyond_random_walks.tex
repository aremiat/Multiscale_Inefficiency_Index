...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{img/price_and_inefficiency_russell_mrs}
    \caption{Log–price trajectory of the Russell 2000. Bottom graph corresponding inefficiency index \(I=\Delta\alpha_{\text{surrogate}} * |H-0.5|\).}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{img/price_and_inefficiency_sp500_mrs}
    \caption{Log–price trajectory of the S\&P 500. Bottom graph corresponding inefficiency index \(I=\Delta\alpha_{\text{surrogate}} * |H-0.5|\).}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{img/price_and_ineffiency_ftse_mrs}
    \caption{Log–price trajectory of the FTSE. Bottom graph corresponding inefficiency index \(I=\Delta\alpha_{\text{surrogate}} * |H-0.5|\).}
    \label{fig:russell-inefficiency}
\end{figure}
\FloatBarrier
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{img/price_and_inefficiency_ssec_mrs}
    \caption{Log–price trajectory of the SSEC. Bottom corresponding inefficiency index \(I=\Delta\alpha_{\text{surrogate}} * |H-0.5|\).}
    \label{fig:sp500-inefficiency}
\end{figure}
\FloatBarrier
