...
outperform the strategies that did not use it confirming the hypothesis that our inefficiency index behaves as a risk management tool.
...
\begin{itemize}
    ...
    Russell 2000 is wider than that of the S\&P 500). Hence, we overweight the Russell 2000, assigning 100\% to it and 20   \% to the S\&P 500.
