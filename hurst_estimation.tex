...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Multifractal spectrum $f(\alpha)$ original vs shuffle for Russell 2000 returns.}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Multifractal spectrum $f(\alpha)$ original vs shuffled for SP500 returns.}
\end{figure}
...
\begin{table}[H]
    \centering
    \pgfplotstabletypeset[
        columns={Strategy,Annual Return,Annual Vol,Sharpe,Max Drawdown},
    ...
    \caption{Performance metrics of the under/over strategies (20 bps transaction fees) compared to the long only SP500 portfolio, long only Russell 2000 portfolio, 50/50 portfolio.}
