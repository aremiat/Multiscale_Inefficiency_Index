...
Analysis approach designed to detect multifractality in time series proposed by (Jan W. Kantelhardt (2002)).
The procedure can be summarized in five steps, as described below:
...
The analysis using the Hölder exponent and singularity spectrum is a powerful tool for studying complex systems.
In particular, it enables one to identify and quantify regions of strong singularity, which may correspond to extreme
...
\begin{figure}[ht]
    ...
    \caption{Comparison of the performance of the over/under strategy (blue, purple, green) with the long only S\&P 500 portfolio (red),
        ...
        The backtest period is from 1988-03-28 to 2025-02-28.}
