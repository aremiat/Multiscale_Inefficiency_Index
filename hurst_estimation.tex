...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            xticklabel style={rotate=45, anchor=east},
            grid=major,
            legend style={font=\footnotesize, at={(0.5,-0.2)},anchor=north,legend columns=-1},
        ]
        ...
        \legend{Rolling Critical Value, Threshold (V=1.620)}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[htbp]
    \centering
    %--- Premier axis : Rolling Critical Value (gauche) ---
    \begin{tikzpicture}
        \begin{axis}[
            name=axis1,
            width=\textwidth,
            ...
            xlabel={Date},
            ylabel={Rolling Critical Value},
            ymin=0, ymax=1.7, % Échelle de gauche
        ]
            %--- Rolling Critical Value ---
            \addplot[
                green,
                thick
            ] table[
            ...
            \addlegendentry{Rolling Critical Value}
        ...
        %--- Second axis : Alpha Width (droite) ---
        \begin{axis}[
            name=axis2,
            at={(axis1.south west)},
            anchor=south west,
            ...
            height=8cm,
            date coordinates in=x,
            xticklabel=\empty,  % On ne veut pas réafficher les dates
            axis x line=none,   % On n'affiche pas l'axe x du 2e
            axis y line=right,  % L'axe Y est à droite
            ymin=0, ymax=1.3,   % Échelle de droite
            ylabel={Alpha Width},
            yticklabel style={color=purple},  % Couleur pour rappeler la courbe
