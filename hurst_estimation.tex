...
\begin{itemize}
    ...
    then the alpha width ($\alpha$max - $\alpha$min) of the S\&P 500 is larger than that of the Russell 2000. This implies that the S\&P 500 exhibits stronger
    ...
    outperforming the S\&P 500), the inefficiency index will be less than 0 (meaning that the alpha width of the
...
\begin{figure}[ht]
    ...
    split into segments of length 800) with a
...
\begin{figure}[ht]
    ...
    \caption{Rolling alpha width difference computed with a rolling window of 252 days
...
\begin{table}[!h]
    ...
    \pgfplotstabletypeset[
        ...
        columns/Sharpe/.style={column name=Sharpe},
        columns/Max Drawdown /.style={column name=Max Drawdown}
    ]{data/backtest_results_start_1995-01-02.csv}
...
\begin{table}[!h]
    ...
    \pgfplotstabletypeset[
        ...
        columns/Sharpe/.style={column name=Sharpe},
        columns/Max Drawdown /.style={column name=Max Drawdown}
    ]{data/backtest_results_start_2000-01-02.csv}
    \caption{2000-01-02-2025-02-28}
    \label{tab:performance_table_2000-01-02}
\end{table}
...
\begin{table}[!h]
    ...
    \pgfplotstabletypeset[
        ...
        columns/Sharpe/.style={column name=Sharpe},
        columns/Max Drawdown /.style={column name=Max Drawdown}
    ]{data/backtest_results_start_2005-01-02.csv}
    \caption{2005-01-02-2025-02-28}
    \label{tab:performance_table_2005-01-02}
\end{table}
...
\begin{table}[!h]
    ...
    \pgfplotstabletypeset[
        ...
        columns/Sharpe/.style={column name=Sharpe},
        columns/Max Drawdown /.style={column name=Max Drawdown}
    ]{data/backtest_results_start_2010-01-02.csv}
    \caption{2010-01-02-2025-02-28}
    \label{tab:performance_table_2010-01-02}
\end{table}
...
\begin{table}[!h]
    ...
    \pgfplotstabletypeset[
        ...
        columns/Sharpe/.style={column name=Sharpe},
        columns/Max Drawdown /.style={column name=Max Drawdown}
    ]{data/backtest_results_start_2015-01-02.csv}
...
\begin{table}[!h]
    ...
    \pgfplotstabletypeset[
        ...
        columns/Sharpe/.style={column name=Sharpe},
        columns/Max Drawdown /.style={column name=Max Drawdown}
    ]{data/backtest_results_start_2020-01-02.csv}
...
\begin{table}[!h]
    ...
    \caption{1988-10-19-2025-02-28 | Window size 120 days}
...
\begin{table}[!h]
    ...
    \caption{1988-10-19-2025-02-28 | Window size 252 days}
...
\begin{table}[!h]
    ...
    \caption{1989-09-18-2025-02-28 | Window size 504 days}
